---
description: Sign in to greprules.io from Claude Code chat so community feedback and rule proposals can submit with a stored CLI token
---

# greprules Auth Login

Use this skill when the user asks `/greprules:auth-login`, asks Claude Code to log in to greprules, connect greprules.io, authorize community contribution, or fix a greprules login-required error.
