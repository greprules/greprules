...
- If multiple Codex sessions have dirty files and no current session id is available, do not merge them; ask the user to run a session-scoped scan or use `$greprules-scan-target <path>`.
