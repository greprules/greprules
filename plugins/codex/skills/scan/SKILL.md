...
Use this skill whenever the user asks Codex to scan with greprules, review greprules results, contribute scan feedback, or turn an independently identified vulnerability into a greprules.io rule proposal.
...
Use this only when the user asks Codex to turn an independently identified vulnerability into a public greprules.io rule proposal. Do not start it automatically from hook output.
